...
DROP TABLE IF EXISTS `tbl_sale_company`;
CREATE TABLE tbl_sale_company
(
    `id`                 BIGINT AUTO_INCREMENT PRIMARY KEY,
    `name`               VARCHAR(255)  NOT NULL,
    `address`            VARCHAR(255),
    `ceo_name`           VARCHAR(25)   NOT NULL,
...
(
    `id`                 bigint         NOT NULL AUTO_INCREMENT,
    `pno`                varchar(12)    NOT NULL UNIQUE,
    ...
    `sale_company_id`    bigint         NOT NULL,
    PRIMARY KEY (`id`),
    KEY `category_id` (`category_id`),
    KEY `sale_company_id` (`sale_company_id`),
    CONSTRAINT `tbl_product_chk_1` CHECK ((`is_visible` in (0, 1))),
    CONSTRAINT `tbl_product_chk_2` CHECK ((`is_sold_out` in (0, 1))),
    CONSTRAINT `tbl_product_chk_3` CHECK ((`is_gmo` in (0, 1))),
    CONSTRAINT `tbl_product_chk_4` CHECK ((`is_deleted` in (0, 1))),
    CONSTRAINT `tbl_category_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `tbl_category` (`id`),
    CONSTRAINT `tbl_sale_company_ibfk_1` FOREIGN KEY (`sale_company_id`) REFERENCES `tbl_sale_company` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci;
...
(
    `id`                    bigint       NOT NULL AUTO_INCREMENT,
    `exchange_address`      varchar(150) NOT NULL,
    `exchange_company_name` varchar(50)  NOT NULL,
    `exchange_post_code`    varchar(5)   NOT NULL,
    `exchange_reason`       varchar(150) NOT NULL,
    `exchange_shipping_no`  varchar(20)  NOT NULL,
    `exchange_state`        varchar(2)   NOT NULL DEFAULT '01',
    `file_name`             varchar(255) NOT NULL,
    `reject_reason`         varchar(150)          DEFAULT NULL,
    `return_company_name`   varchar(50)  NOT NULL,
    `return_shipping_no`    varchar(20)  NOT NULL,
    `return_address`        varchar(150) NOT NULL,
    `return_post_code`      varchar(5)   NOT NULL,
    `created_by`            varchar(120) NOT NULL,
    `created_date`          timestamp    NOT NULL,
    `last_modified_by`      varchar(120) NOT NULL,
    `last_modified_date`    timestamp    NOT NULL,
...
(
    `id`                  bigint       NOT NULL AUTO_INCREMENT,
    `refund_company_name` varchar(50)  NOT NULL,
    `refund_amount`       DECIMAL(10, 2),
    `refund_post_code`    varchar(5)   NOT NULL,
    `refund_reason`       varchar(150) NOT NULL,
    `refund_file_name`    varchar(255) NOT NULL,
    `created_by`          varchar(120) NOT NULL,
    `created_date`        timestamp    NOT NULL,
    `last_modified_by`    varchar(120) NOT NULL,
    `last_modified_date`  timestamp    NOT NULL,
    ...
    PRIMARY KEY (`id`),
    KEY `subscribe_id` (`subscribe_id`),
    CONSTRAINT `tbl_refund_ibfk_1` FOREIGN KEY (`subscribe_id`) REFERENCES `tbl_subscribe` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci;
-- 내보낼 데이터가 선택되어 있지 않습니다.
